...
const char *PCI::GetVendorName(uint16_t vendor)
{
    switch(vendor)
    {
        ...
        default: return ToHexString((uint16_t)vendor);
    }
}
    ...
    switch(vendor)
    {
        case 0x8086:
            switch(device)
            {
                ...
                default: return ToHexString((uint16_t)device);
            }
        case 0x1234:
            switch(device)
            {
    ...
    switch(classcode)
    {
        case 0x00:
            switch(subclasscode)
            {
                ...
                default: return ToHexString((uint8_t)subclasscode);
            }
        case 0x01:
            switch(subclasscode)
            {
        ...
        default: return ToHexString((uint8_t)classcode);
    }
}
